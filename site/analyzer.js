...
exports.feed = function (data) {
    if (data[0] == 1 && data[1] == 1 && data[data.length - 1] == 4) {
        ...
        MPU9250Accel.add(new Reading("X:", data.readFloatLE(12)));
        MPU9250Accel.add(new Reading("Y:", data.readFloatLE(16)));
        MPU9250Accel.add(new Reading("Z:", data.readFloatLE(20)));
        var MPU9250Gyro = new Sensor("MPU9250Gyro");
        MPU9250Gyro.add(new Reading("X:", data.readFloatLE(26)));
        MPU9250Gyro.add(new Reading("Y:", data.readFloatLE(30)));
        MPU9250Gyro.add(new Reading("Z:", data.readFloatLE(34)));
        var MPU9250Mag = new Sensor("MPU9250Mag");
        MPU9250Mag.add(new Reading("X:", data.readFloatLE(38)));
        MPU9250Mag.add(new Reading("Y:", data.readFloatLE(42)));
        MPU9250Mag.add(new Reading("Z:", data.readFloatLE(46)));
        var MPU9250Temp = new Sensor("MPU9250");
        MPU9250Temp.add(new Reading("Sample", data.readInt16LE(50)));
        report.add(BME280);
